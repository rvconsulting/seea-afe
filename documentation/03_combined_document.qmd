...
Turning to the forest sector, the accounts show that countries with higher agricultural GDP shares tend to show greater forest loss in their accounts. @fig-forest-agr shows net forest cover change derived from national SEEA accounts plotted against agricultural value added as a percentage of GDP from WDI [@worldbank_wdi_2026] in the last year of the respective accounting period for the countries with compiled forest or ecosystem extent accounts. Bubble color encodes rural population share (lighter yellow is lower and darker green is higher). Countries below the dashed line experienced net forest loss over the account compilation period. Account reference periods vary by country: Uganda and Rwanda 1990–2015; Zambia 2018–2023; Kenya 2002–2018; South Africa 2018–2022; DR Congo 2000–2020.
...
#| message: false
#| warning: false
#| fig-cap: "Forest cover change and agricultural Value Added as a percentage of GDP"
...
ggplot(forest_nca, aes(
  ...
  scale_y_continuous(limits = c(-65, NA)) +
  scale_fill_gradient(
  ...
  labs(
    ...
    # title    = "Net forest cover change vs agricultural value added as a percentage of GDP",
  ) +
  theme_minimal(base_size = 10) +
